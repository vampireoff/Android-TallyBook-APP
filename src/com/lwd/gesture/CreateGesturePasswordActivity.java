...
import com.lwd.gesture.LockPatternView.DisplayMode;
...
//			updateStage(Stage.HelpScreen);
	...
	protected com.lwd.gesture.LockPatternView.OnPatternListener mChooseNewLockPatternListener = new LockPatternView.OnPatternListener() {
...
//			mLockPatternView.setPattern(DisplayMode.Animate, mAnimatePattern);
	...
	private void saveChosenPatternAndFinish() {
		...
		SharedPreferences sharedPreferences = getSharedPreferences("onoff", Context.MODE_PRIVATE);
